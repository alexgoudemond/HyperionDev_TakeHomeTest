...
This folder contains contains the answer to Section A of the Take-Home Test, which is a code review provided by HyperionDev. It will mimick the feedback I would give to a student, having being given their code.
